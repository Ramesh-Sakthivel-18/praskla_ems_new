...
export default function ManagerOrganizationsPage() {
  ...
  const loadOrganizations = async () => {
    ...
    try {
      const response = await fetch(`${base}/manager/organizations`, {
  ...
  const saveLimits = async () => {
    ...
    try {
      const response = await fetch(`${base}/manager/organizations/${selectedOrg.id}/limits`, {
        method: "PUT",
        headers: {
  ...
  const toggleOrgStatus = async () => {
    ...
    try {
      const response = await fetch(`${base}/manager/organizations/${selectedOrg.id}/${action}`, {
        method: "POST",
        headers: { Authorization: `Bearer ${token}` }
      })
